...
export const scheduleData = {
  "Day 1": {
    ...
    Technical: {
      Coding: [
        { id: "tech-cod-0", time: "9:00 AM - EOD", name: "ARENA X (GDGC)", location: "LT402" },
        { id: "tech-cod-1", time: "9:00 AM - EOD", name: "ARENA X (GDGC)", location: "Library" },
      ...
      STEM: [
        ...
        { id: "tech-ste-4", time: "2:00 PM - 5:30 PM", name: "Escape Room (Qrnania)", location: "LT 201, 202" }
      ],
      Designing: [
      ...
      Business: [
        ...
        { id: "tech-bus-3", time: "1:00 PM - 8:30 PM", name: "Enactus", location: "VCH" }
      ],
      Circuits: [
        { id: "tech-cir-1", time: "10:00 AM - 3:00 PM", name: "Rapid Wire", location: "SB-3" }
      ],
      Gaming: [
        { id: "tech-gam-1", time: "11:00 AM - 9:00 PM", name: "Arena X (Vortex)", location: "VCH" }
      ],
      Managerial: [
    ...
    Cultural: {
      ...
      Dance: [
        ...
        { id: "cult-dan-2", time: "3:00 PM - 6:00 PM", name: "Crew Klash", location: "Snackers" }
      ],
      Drama: [
      ...
      "Hindi Sahitya": [
        { id: "cult-hin-1", time: "10:00 AM - 12:00 AM", name: "Vaad Vivad", location: "SB-2" }
      ],
      Photography: [
        { id: "cult-pho-1", time: "9:00 AM - EOD", name: "Drishya", location: "IT Building" },
        { id: "cult-pho-2", time: "2:00 PM - 5:00 PM", name: "Guest Talk", location: "SB-1" }
      ],
      Videography: [
  ...
  "Day 2": {
    ...
    Technical: {
      ...
      Robotics: [
        { id: "tech-rob-2", time: "9:30 AM - 1:30 PM", name: "Maze Rush", location: "In Front of ICE Buil" },
        { id: "tech-rob-3", time: "10:00 AM - 3:00 PM", name: "Gear Blitz", location: "Main Ground" }
      ],
      STEM: [
        { id: "tech-ste-1", time: "9:30 AM - EOD", name: "ChemXplore", location: "Chem Dept." },
        { id: "tech-ste-5", time: "11:00 AM - 4:00 PM", name: "Mind The Mind", location: "LT 404" },
        { id: "tech-ste-6", time: "10:00 AM - 2:00 PM", name: "Who Killed The Ceil", location: "BT Dept" },
        { id: "tech-ste-7", time: "3:30 PM - 6:00 PM", name: "Enigma 26", location: "ALT" },
        { id: "tech-ste-8", time: "11:00 AM - 1:00 PM", name: "Treasure Hunt (Physical Society)", location: "SB Outside" }
      ],
      Aeronautics: [
      ...
      Gaming: [
        { id: "tech-gam-2", time: "10:00 AM - EOD", name: "Arena X", location: "ALT 1 Floor" },
        { id: "tech-gam-3", time: "10:00 AM - EOD", name: "Arena X", location: "LT402-" }
      ],
      Managerial: [
    ...
    Cultural: {
      ...
      Photography: [
        { id: "cult-pho-3", time: "9:30 AM - 1:30 PM", name: "Snap Treasure", location: "IT Building" }
      ],
      Videography: [
  ...
  "Day 3": {
    ...
    Technical: {
      ...
      STEM: [
        { id: "tech-ste-9", time: "9:30 AM - EOD", name: "STEM MUN", location: "VCH" },
        { id: "tech-ste-10", time: "10:00 AM - EOD", name: "React and Resolve (Online)", location: "Online" }
      ],
      Business: [
        { id: "tech-bus-7", time: "10:30 AM - 12:30 PM", name: "TechBiz Quest 2.0", location: "LT 101" }
      ],
      Circuits: [
        { id: "tech-cir-3", time: "9:00 AM - 7:00 PM", name: "Power Arena", location: "Dominos" }
      ],
      Gaming: [
        { id: "tech-gam-4", time: "10:00 AM - EOD", name: "Arena X", location: "New Library" }
      ]
    },
    Cultural: {
      Music: [
      ...
      Photography: [
        { id: "cult-pho-4", time: "11:00 AM - EOD", name: "Nazariya (Online)", location: "Online" }
      ],
      Videography: [
