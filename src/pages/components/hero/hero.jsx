...
const Hero = ({ introDone }) => {
  ...
  const finalRotateX = useTransform(
    [smoothBgRotateX, effectIntensity],
    ([rot, intensity]) => rot * intensity,
  );
  const finalRotateY = useTransform(
    [smoothBgRotateY, effectIntensity],
    ([rot, intensity]) => rot * intensity,
  );
  ...
  const videos = ["https://youtu.be/IYFe17EnAP8?si=39Aj0aNseu9AhVDS"];
  ...
  const logoScale = useTransform(
    smoothProgress,
    [0, 0.3],
    [1, isMobile ? 0.35 : 0.22],
  );
  const logoXPos = useTransform(
    smoothProgress,
    [0, 0.3],
    ["0%", isMobile ? "34%" : "42%"],
  );
  const logoYPos = useTransform(
    smoothProgress,
    [0, 0.3],
    ["0%", isMobile ? "-43%" : "-42%"],
  );
  ...
  useEffect(() => {
    ...
    const updateStates = (v) => {
      ...
      else if (v < 0.6) setRenderVideo(false);
    };
  ...
  const videoOpacity = useTransform(smoothProgress, [0.7, 0.77], [0, 1]);
  const videoY_smooth = useTransform(smoothProgress, [0.7, 0.77], [140, 0]);
        ...
        <AnimatePresence>
          {startImageReveal && (
            ...
            >
              ...
              >
                <div
                  className="relative w-full aspect-video rounded-[1.2vw] overflow-hidden bg-black"
                  style={{
                    boxShadow: "15px 30px 60px rgba(0,0,0,0.5)",
                    border: "3px solid rgba(209, 249, 3)",
                  }}
                >
                  <div
                ...
                <div className="flex justify-center mt-[1.5vw]">
                  <div className="flex items-center gap-[1.2vw] px-[1.5vw] py-[0.6vw] bg-[#0b0b0b] rounded-[0.4vw] border-x-[3px] border-[#d1f903] relative shadow-2xl">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M6 18V6h2v12H6zm3.5-6L18 6v12l-8.5-6z"
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center p-[10%]">
                    ...
                    >
                      Utkansh-26 at NIT Jalandhar blends culture and technology
                      in perfect harmony. Experience electrifying performances
                      like Panache,BDM Night, and Star Night, alongside
                      innovative events like Hackathons, RC Racing, NIT-yaan,
                      Startup Mela, and Avishkar Exhibitions. Join us for an
                      unforgettable celebration of talent, innovation, and
                      creativity that promises to inspire and entertain.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                className="hidden md:block absolute right-[16%] top-[12%] w-[23%]"
                style={{
                  transformStyle: "preserve-3d",
                  y: contentParallaxY,
