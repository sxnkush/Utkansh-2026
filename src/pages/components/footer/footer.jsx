...
const Footer = () => {
    // Definining the neon color as a constant for easy reuse
    ...
    return (
        ...
        >
            {/* Dark overlay to ensure text readability against graffiti BG */}
            ...
            <div className="w-full max-w-7xl flex flex-col md:flex-row justify-between items-center md:items-start gap-12 relative z-10">
                ...
                {/* Left Section: Logo - Pushed to the left */}
                ...
                {/* Center Section: Navigation, Socials, and Brochure */}
                <div className="flex flex-col items-center gap-6 md:mt-12">
                    ...
                    <div className="flex gap-6 items-center">
                        {[
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill={social.isOutline ? "none" : "currentColor"} stroke={social.isOutline ? "currentColor" : "none"} strokeWidth="2">
                                    {social.isOutline ? (
                                        <>
                ...
                <div className="flex flex-col items-center md:items-end gap-3 min-w-[280px] w-full md:w-auto md:mt-12">
                    {/* Centering Title relative to line */}
                    ...
                    <div className="flex items-center gap-2 mt-2 tracking-widest">
                        {/* Mail SVG moved before the email */}
